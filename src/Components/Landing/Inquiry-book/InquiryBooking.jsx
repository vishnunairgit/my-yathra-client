...
function InquiryBooking() {
  ...
  return (
    <div>
      <div className="carousal-inquiry">
        {/* Left side: Carousel */}
          ...
          <div id="carouselExampleCaptions" className="carousel slide" data-bs-ride="carousel">
            ...
            <div className="carousel-inner">
              <div className="carousel-item active">
                ...
                <div className="carousel-caption d-none d-md-block">
                  <h5>Vibrant Nightlife</h5>
                  <p>Feel the pulse of Pattaya’s electric nightlife, filled with music, lights, and excitement.</p>
                </div>
              </div>
              <div className="carousel-item">
                <img src={img2} className="d-block w-100" alt="Cultural Wonders" />
                <div className="carousel-caption d-none d-md-block">
                  <h5>Cultural Wonders</h5>
                  <p>Discover Pattaya’s cultural gems like the breathtaking Sanctuary of Truth and floating markets.</p>
                </div>
              </div>
              <div className="carousel-item">
                <img src={img3} className="d-block w-100" alt="Serene Beaches" />
                <div className="carousel-caption d-none d-md-block">
                  <h5>Serene Beaches</h5>
                  <p>Unwind by Pattaya’s stunning beaches with crystal-clear waters and golden sands.</p>
                </div>
              </div>
            </div>
            <button className="carousel-control-prev" type="button" data-bs-target="#carouselExampleCaptions" data-bs-slide="prev">
        ...
        {/* Right side: Form */}
        <div className="inquiry-bookTrip">
          <form onSubmit={handleBookNow}>
            <h3>Book Your Trip</h3>
            <div className="mb-3">
              <label htmlFor="UserName" className="form-label">Name <span className="mandatory-indicator">*</span></label>
              <input type="text" name="UserName" className="form-control" onChange={handlebooking} placeholder="Enter your Name" required />
            </div>
            <div className="mb-3">
              <label htmlFor="UserPhoneNumber" className="form-label">Phone Number <span className="mandatory-indicator">*</span></label>
              <input type="text" className="form-control" name="UserPhoneNumber" onChange={handlebooking} placeholder="Enter your phone number" required />
            </div>
            <div className="mb-3">
              <label htmlFor="userEmail" className="form-label">Email </label>
              <input type="email" className="form-control" name="userEmail" onChange={handlebooking} placeholder="Enter your email Id" />
            </div>
            <button type="submit" className="btn btn-primary">Submit</button>
          </form>
        </div>
